"""
🎞️ MOV → MP4 BATCH CONVERTER (No tqdm or shutil)
...
- Converted MP4 files will be saved into: 'converted_to_mp4'
"""
...
def batch_convert_mov_to_mp4(input_folder):
    ...
    if not mov_files:
        print("⚠️ No MOV files found in the directory.")
        return
